...
| **2  Query-time pipeline**      | **2.1 Query embedding**                                                                              | `embed_query(text, model_id)`                         | ✅                    |
|                                 | **2.2 Similarity calc** – query vs. chunk vectors                                                    | `compute_chunk_similarities(query_vec, chunk_embeds)` | ✅                    |
